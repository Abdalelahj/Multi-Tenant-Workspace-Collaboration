...
let WorkspaceGuard = class WorkspaceGuard {
    ...
    async canActivate(context) {
        ...
        if (!userId || !workspaceId) {
            throw new common_1.UnauthorizedException('Missing X-User-Id or X-Workspace-Id header');
        }
        ...
        if (user.workspaceId !== workspaceId) {
            throw new common_1.ForbiddenException('User does not belong to this workspace');
        }
        request.user = user;
